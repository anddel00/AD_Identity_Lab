  ...
  // LOGICA PRELOADER (Copiata identica dall'index per consistenza)
  ...
  // Fade In Observer per gli elementi che appaiono scorrendo
  document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.section-title, .hero-subtitle, .faq-accordion').forEach(item => observer.observe(item));
  ...
  // Logica Mouse Torcia (Adattata per lo scorrimento della pagina)
